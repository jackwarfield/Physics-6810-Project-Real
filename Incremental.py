...
class Gear:
    def __init__(self, name, cost, quantity, per_second=0, limit=0):
        self.gear = name
        self.cost = cost
...
class Clicker:
    def __init__(self, parent):
        ...
        self.gear['want'] = Gear('want', 100, 0, per_second = 5, limit=20)
        ...
        self.purchase_buttons['clicker upgrade']= tk.Button(parent, text='Two handed hit: (%d): 0' % self.gear['clicker upgrade'].cost,
            command=lambda: self.purchase('clicker upgrade'))
        ...
        self.current_click_show.grid(row=0, column=1, columnspan=2)
        manual_row = 0
        auto_row= 0
