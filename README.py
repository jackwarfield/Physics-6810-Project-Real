...
This is an incremental (moreso a decremental) game meant to utilize tkinter. There are 4 files with which I have put different versions of the game so it is easy to view all of the
...
Incremental_test2.py: the event version of the game
...
Overall, I plan to continue to add to the game and create more dependences between events, fetch, and the decrementation. But for now, this is it.
"""
